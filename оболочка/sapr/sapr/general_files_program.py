"""! @brief Определяет класс GeneralFilesProgram - всплывающее окно для открытия промежуточных файлов через
программный САПР. """
##
# @file general_files_program.py
#
# @brief Определяет класс GeneralFilesProgram.
#
# @section description_general_files_program Описание
# Определяет создание функционального окна приложения, предназначенного для открытия промежуточных файлов через
# программный САПР.
# - GeneralFilesProgram
#
# @section libraries_general_files_program Библиотеки/Модули
# - PyQt5
# - subprocess
# - os
#
#
# @section todo_general_files_program TODO
# - None.
#
# @section author_general_files_program Авторы
...
class GeneralFilesProgram(object):
    """! Класс GeneralFilesProgram.

    Определяет создание окна приложения, в котором есть возможность открыть .step файлы через программный САПР.
    """

    def __init__(self):
        """! Конструктор класса GeneralFilesProgram.
    ...
    def setupUi(self, Dialog):
        ...
        ## Описание виджета названия окна GeneralFilesProgram.
    ...
    def retranslateUi(self, Dialog):
        ...
        self.text_name_const.setText(_translate("Dialog", "ПРОГРАММИРОВАНИЕ"))
        self.text_const.setText(_translate("Dialog", "КОНУСТРУКЦИЯ"))
    ...
    def open_step(self, module):
        """! Открывает промежуточный файл поданного на вход модуля через программный САПР.

                @return  Окно с запущенным приложением программного САПР, открывающим заданный промежуточный файл.
                """

        ## Открытие файла preferences для нахождения нужного программного сапр.
        ...
        ## Запуск программного САПР
        if prog == "CUBE":
            cube = fr"\\172.18.202.140\projects\{self.project}\{module}\промежуточные_файлы\{self.project}.step"
